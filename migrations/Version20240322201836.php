 ...
 */
final class Version20240322201836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE championship (id INT AUTO_INCREMENT NOT NULL, season_id INT NOT NULL, organizing_club_id INT NOT NULL, championship_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', championship_inscriptions_limit_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', place VARCHAR(255) NOT NULL, number SMALLINT NOT NULL, is_current_championship TINYINT(1) NOT NULL, INDEX IDX_EBADDE6A4EC001D1 (season_id), INDEX IDX_EBADDE6A55C13187 (organizing_club_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE organization_team (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(120) NOT NULL, organization_role VARCHAR(100) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE season (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(15) NOT NULL, is_current_season TINYINT(1) NOT NULL, is_archived TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
